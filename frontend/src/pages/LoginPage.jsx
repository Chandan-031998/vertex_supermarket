...
export default function LoginPage() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-slate-100 p-4"
    ...
    >
      <div className="w-full max-w-md card p-8">
        {settings.logo_path ? <img src={settings.logo_path} alt={settings.app_name} className="mb-4 h-14 w-14 rounded-2xl object-cover" /> : null}
